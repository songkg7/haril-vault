...
$TranslateRenderedDocSelectionAction               <M-C-U>
...
Activateaws.cloudformationToolWindow
Activateaws.cloudwatchlogsToolWindow
Activateaws.codewhisperer.codereferenceToolWindow
Activateaws.sqsToolWindow
Activateaws.toolkit.explorerToolWindow
ActivateBeanValidationToolWindow
ActivateBigDataToolWindowToolWindow                <C-B>
ActivateBookmarksToolWindow                        <M-2>
ActivatebspToolWindow
Activatecom.haulmont.jpb.jpaInspectorToolWindow
Activatecom.haulmont.jpb.jpaPaletteToolWindow
Activatecom.haulmont.jpb.jpaStructureToolWindow
ActivateCommitToolWindow
ActivateDatabaseChangesToolWindow
ActivateDatabaseToolWindow
ActivateDatabricksToolWindowToolWindow
ActivateDebugToolWindow                            <M-5>
ActivateDependenciesToolWindow
ActivateDependencyCheckerToolWindow
ActivateEmrToolWindowToolWindow
ActivateEndpointsToolWindow
ActivateFileTransferToolWindow
ActivateFindToolWindow                             <M-3>
ActivateFlinkToolWindowToolWindow
ActivateGitLabMergeRequestsToolWindow
ActivateGlueToolWindowToolWindow
ActivateGradleToolWindow
Activatehadoop-toolwindowToolWindow
ActivateHierarchyToolWindow
ActivateHiveToolWindowToolWindow
Activateinternal-profilerToolWindow
ActivateInternalMethodTracingToolWindow
ActivateJavaEnterpriseToolWindow
ActivateJsonParserToolWindow
ActivateKafkaToolWindowToolWindow
ActivateKeyPromoterXToolWindow
ActivateKotestToolWindow
...
Activatesbt-shell-toolwindowToolWindow             <M-S-S>
...
ActivateSparkMonitoringToolWindowToolWindow
ActivateSpringToolWindow
ActivateStringManipulationToolWindow
...
Activatezeppelin-shell-toolwindowToolWindow
...
AnonymousToInner
apprunner.service.copyServiceUri
apprunner.service.create
apprunner.service.delete
apprunner.service.deploy
apprunner.service.openServiceUri
apprunner.service.pause
apprunner.service.resume
apprunner.service.showApplicationLogs
apprunner.service.showSystemLogs
...
AtomFileIcons.ArrowStyles
AtomFileIcons.OldToolbar
AttachIntellijSourcesAction
AttachProfilerToLocalProcess
AttachProject
AutoIndentLines                                    <A-C-I>
AutoShowProcessWindow
aws.settings.refresh
aws.settings.selector
aws.settings.show
aws.settings.upsertCredentials
aws.toolkit.codewhisperer.toolbar.security
aws.toolkit.dynamic.resource.editor
aws.toolkit.dynamodb.delete_table
aws.toolkit.dynamoViewer.changeMaxResults
aws.toolkit.dynamoViewer.toolbar.primary
aws.toolkit.dynamoViewer.toolbar.secondary
aws.toolkit.dynamoViewer.toolbar.settings
aws.toolkit.ecr.repository.pull
aws.toolkit.ecr.repository.push
aws.toolkit.explorer.apprunner
aws.toolkit.explorer.apprunner.service
aws.toolkit.explorer.cloudformation
aws.toolkit.explorer.cloudformation.stack
aws.toolkit.explorer.codewhisperer
aws.toolkit.explorer.dynamic.more.resources
aws.toolkit.explorer.dynamic.resource
aws.toolkit.explorer.dynamic.resource.type
aws.toolkit.explorer.dynamodb.table
aws.toolkit.explorer.ecr
aws.toolkit.explorer.ecr.repository
aws.toolkit.explorer.ecr.tag
aws.toolkit.explorer.ecs.cluster
aws.toolkit.explorer.ecs.service
aws.toolkit.explorer.lambda
aws.toolkit.explorer.lambda.function
aws.toolkit.explorer.logs.group
aws.toolkit.explorer.rds
aws.toolkit.explorer.rds.instance
aws.toolkit.explorer.redshift
aws.toolkit.explorer.redshift.cluster
aws.toolkit.explorer.s3
aws.toolkit.explorer.s3.bucket
aws.toolkit.explorer.schemas
aws.toolkit.explorer.schemas.registry
aws.toolkit.explorer.schemas.schema
aws.toolkit.explorer.sqs
aws.toolkit.explorer.sqs.queue
aws.toolkit.explorer.titleBar
aws.toolkit.explorer.titleBar.terminal
aws.toolkit.open.arn.browser
aws.toolkit.open.telemetry.viewer
aws.toolkit.s3.open.bucket.viewer
aws.toolkit.s3.open.bucket.viewer.prefixed
aws.toolkit.s3viewer.contextMenu
aws.toolkit.s3viewer.contextMenu.copyGroup
aws.toolkit.s3viewer.miscActions
aws.toolkit.s3viewer.mutateActions
aws.toolkit.s3viewer.toolbar
aws.toolkit.s3viewer.transferActions
aws.toolkit.s3viewer.versionActions
aws.toolkit.serverless.template
aws.toolkit.showFeedback
Back                                               <M-[> <M-A-Left> button=4 clickCount=1 modifiers=0
BackgroundTasks
BasicEditorPopupMenu
Batch.Job.Create
BdIde.TableEditor.PopupActionGroup
BdideZeppelinGotoNotebookAction                    <M-A-S-G>
BigDataTools.BdiCopyHeaderAction
BigDataTools.BdiTableCopyColumnAction
BigDataTools.BdiTableCopyRowAction
BigDataTools.BdiTableDumpToClipboardAction
BigDataTools.BdiTableDumpToFileAction
BigDataTools.DumpTableGroup
BigDataTools.FindInEditor                          <M-F>
BiggerIconsAction
...
cloudformation.stack.view
cloudwatch.logs.delete.group
...
CodeEditorViewGroup
CodeFormatGroup
CodeGlance.toggle                                  <M-S-G>
CodeInsightEditorActions
CodeInspection.OnEditor                            <A-S-I>
CodeMenu
CodeVision.ShowMore
codewhisperer.settings
codewhisperer.toolbar.security.scan
codewhisperer.whatIs
CodeWhispererRecommendationAction                  <A-C>
...
com.haulmont.jpb.action.SwitchJpaStateAction
...
com.haulmont.jpb.deleteDataStoreAction             <Del> <BS> <M-BS>
com.haulmont.jpb.deletePersistenceUnit             <Del> <BS> <M-BS>
...
com.haulmont.jpb.generateSpringDataSource
com.haulmont.jpb.HideAllJpaWindows
...
Debugger.PopFrame
Debugger.ReloadFile
Debugger.RemoveAllBreakpoints                      <A-B>
...
DeleteObjectAction                                 <Del> <BS> <M-BS>
DeleteOldAppDirs
...
Dvcs.Log.Toolbar
dynamic.resource.addResourcesToExplorerAction
...
dynamic.resource.explorer.copy.identifier
dynamic.resource.explorer.dynamicResourceDeleteResourceAction
dynamic.resource.explorer.openFileForUpdateAction
dynamic.resource.explorer.openReadOnlyAction
dynamic.resource.type.explorer.createResource
dynamic.resource.type.explorer.viewDocumentation
ecr.image.copyUri
ecr.image.createAppRunnerService
ecr.image.delete
ecr.repository.copyUri
ecr.repository.create
ecr.repository.delete
ecr.repository.push.group
ecs.container.actions
ecs.exec.disable
ecs.exec.enable
ecs.service.showLogGroup
EditBookmark
EditBookmarksGroup
...
InvalidateCaches
InvertBoolean
io.kotest.actions.NextTestAction                   <A-N>
io.kotest.actions.PreviousTestAction               <A-P>
J2EEGenerateGroup
J2EEViewPopupMenu
...
Kubernetes.Delete
Kubernetes.Edit                                    <M-Down> <F4>
Kubernetes.HelmCreateChart
Kubernetes.HelmDependencyUpdate
Kubernetes.HelmGenerateDependency
Kubernetes.HelmLint
Kubernetes.HelmTemplateDiff
Kubernetes.Refresh                                 <M-R>
Kubernetes.RefreshConfiguration
Kubernetes.ReloadContent                           <M-R>
Kubernetes.ViewSettings
KUBERNETES_ACTIONS
lambda.function.create
lambda.function.delete
lambda.function.gotohandler
lambda.function.updateCode
lambda.function.updateConfiguration
lambda.function.viewLogStream
...
MainToolBarSettings
Majera.CodeReview.GitLab.ApproveOrUnapprovePullRequest
Majera.CodeReview.GitLab.ChangeCommentsSortingMode
Majera.CodeReview.GitLab.ChangeFileReviewedState
Majera.CodeReview.GitLab.ChangePullRequestCommentsMode
Majera.CodeReview.GitLab.ChangeToolWindowOrientation
Majera.CodeReview.GitLab.CheckoutPullRequestBranch
Majera.CodeReview.GitLab.ChoosePullRequestSearchScope
Majera.CodeReview.GitLab.ClearNotifications
Majera.CodeReview.GitLab.ContextPullRequestToolbar
Majera.CodeReview.GitLab.ContextPullRequestToolbar.Settings
Majera.CodeReview.GitLab.CopyPullRequestLink
Majera.CodeReview.GitLab.CreateGeneralTask
Majera.CodeReview.GitLab.CreatePullRequest
Majera.CodeReview.GitLab.CustomDiffToolbar
Majera.CodeReview.GitLab.EditPullRequest
Majera.CodeReview.GitLab.FindPullRequestByCommit
Majera.CodeReview.GitLab.FindPullRequestByWebUrl
Majera.CodeReview.GitLab.GitLab.CloseOrReopenPullRequest
Majera.CodeReview.GitLab.GitlabAddOrRemoveCurrentUserToPullRequest
Majera.CodeReview.GitLab.GitlabFilterChanges
Majera.CodeReview.GitLab.GitlabShowOnlyPullRequestsAssignedToMe
Majera.CodeReview.GitLab.GitlabShowOnlyPullRequestsReviewedOrAssignedToMe
Majera.CodeReview.GitLab.Help
Majera.CodeReview.GitLab.JumpToSource
Majera.CodeReview.GitLab.LeaveCommentForLineAction <M-S-X>
Majera.CodeReview.GitLab.LeaveFileComment
Majera.CodeReview.GitLab.LeaveGeneralComment
Majera.CodeReview.GitLab.ManageRepositories
Majera.CodeReview.GitLab.MarkFilesReviewedAutomatically
Majera.CodeReview.GitLab.MergePullRequest
Majera.CodeReview.GitLab.NextCommentInDiff
Majera.CodeReview.GitLab.NextCommentInOrdinaryEditor
Majera.CodeReview.GitLab.NotificationsToolbar
Majera.CodeReview.GitLab.OpenCodeReviewApplicationSettings
Majera.CodeReview.GitLab.OpenCommitInBrowser
Majera.CodeReview.GitLab.OpenPullRequestInBrowser
Majera.CodeReview.GitLab.PrevCommentInDiff
Majera.CodeReview.GitLab.PrevCommentInOrdinaryEditor
Majera.CodeReview.GitLab.PullRequestAuthorFilter
Majera.CodeReview.GitLab.PullRequestBlockerCommentsToolbar
Majera.CodeReview.GitLab.PullRequestChangesToolbar
Majera.CodeReview.GitLab.PullRequestChangesToolbar.Right
Majera.CodeReview.GitLab.PullRequestCommentsToolbar
Majera.CodeReview.GitLab.PullRequestDetailsToolbar
Majera.CodeReview.GitLab.PullRequestInfoToolbar
Majera.CodeReview.GitLab.PullRequestParticipantsToolbar
Majera.CodeReview.GitLab.PullRequestSortingMode
Majera.CodeReview.GitLab.PullRequestStateFilter
Majera.CodeReview.GitLab.PullRequestsToolbar
Majera.CodeReview.GitLab.PullRequestsToolWindowSettings
Majera.CodeReview.GitLab.PullRequestTasksToolbar
Majera.CodeReview.GitLab.PullRequestTextFilter
Majera.CodeReview.GitLab.ReadAllNotifications
Majera.CodeReview.GitLab.RefreshContextPullRequests
Majera.CodeReview.GitLab.RefreshPullRequests       <M-R>
Majera.CodeReview.GitLab.RefreshSinglePullRequest  <M-R>
Majera.CodeReview.GitLab.SetNeedsWorkStatusForPullRequest
Majera.CodeReview.GitLab.SetScopeChangesGrouping
Majera.CodeReview.GitLab.ShowCommentListInDiff
Majera.CodeReview.GitLab.ShowCommentListInOrdinaryEditor
Majera.CodeReview.GitLab.ShowContextPullRequestFileDiff
Majera.CodeReview.GitLab.ShowingCommentsInOrdinaryEditorMode
Majera.CodeReview.GitLab.ShowInlineCommentsInDiff
Majera.CodeReview.GitLab.ShowNotifications
Majera.CodeReview.GitLab.ShowOutdatedComments
Majera.CodeReview.GitLab.ShowPullRequestDiffPreview
Majera.CodeReview.GitLab.ShowResolvedBlockerComments
Majera.CodeReview.GitLab.ShowResolvedComments
Majera.CodeReview.GitLab.ShowReviewedFileCount
Majera.CodeReview.GitLab.SubmitAllDraftsForPullRequest
MakeAllJarsAction
MakeExplicit
MakeJarAction
MakeModule
...
MarkRootGroup
MarkSourceRootGroup
MaterialLiteTheme.ContrastThemeChooser
MaterialLiteTheme.Menu
MaterialLiteTheme.ThemeChooser
MaterialTheme.ThemeChooser.Contrast.Dark
MaterialTheme.ThemeChooser.Contrast.Light
MaterialTheme.ThemeChooser.Dark
MaterialTheme.ThemeChooser.Light
...
MoveEditorToOppositeTabGroup                       <A-C-]> <A-C-[>
...
MoveTabRight
MTArcDarkTheme
MTArcDarkThemeContrast
MTArrowsArrows
MTDarculaArrows
MTDarkerTheme
MTDarkerThemeContrast
MTDeepOceanTheme
MTDeepOceanThemeContrast
MTDraculaTheme
MTDraculaThemeContrast
MTForestTheme
MTForestThemeContrast
MTGitHubDarkTheme
MTGitHubDarkThemeContrast
MTGitHubTheme
MTGitHubThemeContrast
MTLighterTheme
MTLighterThemeContrast
MTLightOwlTheme
MTLightOwlThemeContrast
MTMaterialArrows
MTMonokaiTheme
MTMonokaiThemeContrast
MTMoonlightTheme
MTMoonlightThemeContrast
MTNightOwlTheme
MTNightOwlThemeContrast
MTNoneArrows
MTOceanicTheme
MTOceanicThemeContrast
MTOneDarkTheme
MTOneDarkThemeContrast
MTOneLightTheme
MTOneLightThemeContrast
MTPalenightTheme
MTPalenightThemeContrast
MTPlusMinusArrows
MTSolarizedDarkTheme
MTSolarizedDarkThemeContrast
MTSolarizedLightTheme
MTSolarizedLightThemeContrast
MTSynthwaveTheme
MTSynthwaveThemeContrast
MTVolcanoTheme
MTVolcanoThemeContrast
NavBar-cancel                                      <Esc>
...
NoteEditorDeleteLine                               <M-BS>
NoteMoveLineDown                                   <A-S-Down>
NoteMoveLineUp                                     <A-S-Up>
NoteToggleLineWrap
Notifications
OasEndpointsSidePanelSaveAction                    <C-O>
OnlineDocAction
openAssertEqualsDiff                               <M-D>
OpenAwsLocalTerminal
...
OpenInSceneBuilder
OpenLocalSparkSubmitRunConfiguration
...
OpenSshSparkSubmitRunConfiguration
...
randomness.ArrayQuickSwitchScheme
randomness.ArraySettings
randomness.DecimalQuickSwitchScheme
randomness.DecimalSettings
randomness.InsertDecimal
randomness.InsertDecimalArray
randomness.InsertDecimalRepeat
randomness.InsertDecimalRepeatArray
randomness.InsertInteger
randomness.InsertIntegerArray
randomness.InsertIntegerRepeat
randomness.InsertIntegerRepeatArray
randomness.InsertString
randomness.InsertStringArray
randomness.InsertStringRepeat
randomness.InsertStringRepeatArray
randomness.InsertUuid
randomness.InsertUuidArray
randomness.InsertUuidRepeat
randomness.InsertUuidRepeatArray
randomness.InsertWord
randomness.InsertWordArray
randomness.InsertWordRepeat
randomness.InsertWordRepeatArray
randomness.IntegerQuickSwitchScheme
randomness.IntegerSettings
randomness.ShowGroup                               <A-R>
randomness.StringQuickSwitchScheme
randomness.StringSettings
randomness.UuidQuickSwitchScheme
randomness.UuidSettings
randomness.WordQuickSwitchScheme
randomness.WordSettings
rds.mysql.iamauth
rds.mysql.secretsmanager
rds.secretsmanager
...
redshift.cluster.iamauth
redshift.cluster.secretsmanager
redshift.secretsmanager
...
Scala.CompilerHighlightingScala2
Scala.CompilerHighlightingScala3
Scala.ConfigureTypeHints
Scala.CopyWorksheet
Scala.CreateLightWorksheetAction                   <M-A-S-X>
Scala.CreateScalaDocStub
Scala.DecompileToJava
Scala.Desugar                                      <M-A-D>
Scala.EditPackagePrefix
...
Scala.ToggleRangeExclusiveHintAction
Scala.ToggleRangeHintsForToAndUntilAction
Scala.TypeInfo                                     <C-S-P>
ScalaConsole.Clean                                 <M-L>
ScalaConsole.Execute                               <CR> <M-CR>
ScalaConsole.NewLine                               <M-S-CR>
ScalaGenerateGroup
schemas.registry.search
schemas.schema.downloadCode
schemas.schema.view
schemas.search
...
XSD2Document
Zeppelin.ExtractJob
Zeppelin.ExtractToMethod
ZeppelinCellActions
ZeppelinClearCellOutput                            <C-S-L>
ZeppelinClearOutputs
ZeppelinCloneCellAction
ZeppelinDeleteCellAction                           <A-C-D>
ZeppelinInsertCellAboveAction                      <A-C-A>
ZeppelinInsertCellBelowAction                      <A-C-B>
ZeppelinMergeCellsAction
ZeppelinMoveCellAboveAction                        <M-A-K>
ZeppelinMoveCellBelowAction                        <M-A-J>
ZeppelinRestartCellAction
ZeppelinRunAllAboveAction                          <A-C-S-CR>
ZeppelinRunAllBelowAction                          <C-S-CR>
ZeppelinRunCellAction                              <S-CR>
ZeppelinRunCellSelectBelowAction                   <C-CR>
ZeppelinSelectCellAboveAction                      <C-Up>
ZeppelinSelectCellBelowAction                      <C-Down>
ZeppelinSplitCellAction                            <M-S-S>
ZeppelinStopCellAction                             <M-A-C> <M-F2>
ZeppelinToggleCellTitle                            <M-S-F6>

...
바빠서 발표 준비를 못한다기보다, 어디서부터 시작해야할지 모르겠다는 분들을 위해 짤막하게 준비해본 세션입니다. 네트워크 모니터링 및 실험에 사용할 수 있는 다양한 도구들에 대해 소개하고 사용법을 설명합니다.
...
- 네트워크 관련 실험을 위해서는 네트워크 모니터링 관련 도구 사용법이 요구

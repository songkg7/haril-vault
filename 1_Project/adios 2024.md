...
도메인이 고정되니 온전히 나만의 공간이 생긴 것 같아서 아주 만족스럽다. 블로그 플랫폼은 [[Docusaurus]] 로 정했다. 이유는 [Jekyll 블로그를 Docusaurus 로 이사하기 \| HARIL](https://haril.dev/blog/2024/07/22/Blog-Migration-to-Docusaurus-from-Jekyll) 에 자세한 이유가 나와있다.
...
어찌되었건 늘 꿈꾸던 판교 라이프를 보낼 수 있게 되었으나, 현실은 출퇴근 지옥을 맛보고 있다(door-to-door 가 3시간...). 시간을 아끼기 위해 조만간 회사 근처로 이사하려고 계획 중이다.
...
꿈이 있다. 돈을 아주아주 많이 벌어서 재단을 만들고, 사회적 문제 해결에 적극적으로 나서고 싶다는.
...
그래서 그냥 지금 후원을 시작했다. 소액이지만. 세상에는 내가 돈을 많이 벌 때까지 기다려주지 못하는 사람들이 많다. 바로 시작하는게 더 큰 의미가 있을 것이라는 생각이 들었다.
...
- [^2]: 고작 이 이야기 하려고 이렇게 길게 빌드업을 하는 사람이 또 있을까

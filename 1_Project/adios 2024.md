...
도메인이 고정되니 온전히 나만의 공간이 생긴 것 같아서 아주 만족스럽다. 블로그 플랫폼은 [[Docusaurus]] 로 정했다. 이유는 [Jekyll 블로그를 Docusaurus 로 이사하기 \| HARIL](https://haril.dev/blog/2024/07/22/Blog-Migration-to-Docusaurus-from-Jekyll) 글에 자세한 이유가 나와있다.
...
추가적으로 [[Fixture Monkey]] 에도 기여했다. 공식 문서 번역 작업 및 간단한 기능을 추가했다. 자주 쓰는 라이브러리라 더 유명해졌으면 좋겠다. 정말 좋은 라이브러리인데 사람들이 아직 잘 모르는 것 같다.
...
24년 추석, 부모님이 귀경길에 교통사고를 당하셨고[^1], 경황이 없어 그 날 공부하며 정리한 내용을 커밋하지 못했다. 정신을 차려보니 이미 자정이 지나있던 것이다. 그렇게 거의 3년을 열심히 유지한 1일1커밋은 지켜지지 못했다.

고민이 됐다. 1일1커밋을 다시 시작해야할까.

생각보다 길게 고민하지는 않았다. 이런거 안해도 내가 매일 공부한다는 사실이 변하지 않고, 앞으로도 그럴 것이라는 확신이 있었다. 이미 매일 공부하는건 루틴이 된지 오래인데 뭘. 곧바로 그동안 커밋 기록이 사라질까 두려워 지우지 못했던, 필요없어진 깃허브 리포지토리를 모두 지우거나 아카이브 처리했다.
...
일을 시작한지 만 2년이 흘렀을 때부터 조금씩 다른 회사를 알아보기 시작했다. 같은 회사에 여러 해 있으면서, 고이는 느낌이 드는게 싫었다. 여러 번의 면접을 봤고 결과적으로는 현재 회사로 오게 되었다. 현 회사 면접이 여러 의미로 아주아주 힘들었는데, 이 점이 선택의 이유 중 하나다. 자세히 설명할 수 없는게 참 아쉽다.

어찌되었건 늘 꿈꾸던 판교 라이프를 보낼 수 있게 되었고, 출퇴근 지옥을 맛보고 있다(door-to-door 가 3시간...). 출퇴근 시간을 아끼기 위해 조만간 회사 근처로 이사하려고 계획 중이다.
...
따라서 중요한 것은 특정 날을 특별하게 만드는 것이 아니라, **“모든 날이 똑같이 중요하고 소중하다”** 는 가치관을 가지는 것이다. 이러한 태도를 통해 나는 기념일에도 특별한 감흥을 느끼지 않게 되었으며, 대신 매일매일 감사한 마음으로 하루를 살아가게 되었다. 일상은 본래 그 자체로 소중하며, 이를 깨닫는 것이야말로 진정으로 가치 있는 삶을 사는 방법이라 생각한다.

_그저 기념일에 관심이 없는걸 합리화할 수단을 찾아버린걸까_

서론이 너무 길었다. 이 인간 그래서 회고는 언제 써야한다는거야.

이렇게 25년을 맞이 하며 24년 회고를 쓰고 있지만 **사실 회고는 그냥 아무때나 쓰면 되는 것**[^2]이다. 이번에는 그저 흐름에 편승해본다. 시의적절하니 보기 좋은 것 외의 더 큰 이유나 가치는 느껴지지 않는다.

 [낙관적 허무주의](https://youtu.be/oBIo2AyjNMo?si=Fq6ZNOaP4D61Jv6a) 인 것이다. 하루의 가치에 대해, 그 소중함에 대해.
...
- [^1]: 폐차해야할 정도로 큰 사고였지만 다행히 크게 다치지는 않으셨다.
- [^2]: 고작 이 이야기 하려고 이렇게 길게 빌드업을...
